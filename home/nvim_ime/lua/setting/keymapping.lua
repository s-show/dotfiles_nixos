...
vim.keymap.set("n", "<C-g>p", function() tmux_operate.send_key_tmux_frontend('C-p') end, { desc = "Send <Ctrl-u to tmux pane" })
vim.keymap.set("n", "<Enter>", function() tmux_operate.send_key_tmux_frontend('Enter') end, { desc = "Send <Enter> to tmux pane" })
vim.keymap.set("n", "<Tab>", function() tmux_operate.send_key_tmux_frontend('Tab') end, { desc = "Send <Tab> to tmux pane" })
vim.keymap.set("n", "<S-Tab>", function() tmux_operate.send_key_tmux_frontend('S-Tab') end, { desc = "Send <Shift-Tab> to tmux pane" })
